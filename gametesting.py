...
def player_animation():
    #walker animation när gubben står på govet
    #jump animation när gubben "hoppar" och är i luften
...
pygame.display.set_caption('Olivia game')
...
game_name = test_font.render('Olivia Runner', False,(111,196,169))
